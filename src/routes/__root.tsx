...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://tvg.gold/og-image.png" },
      { name: "twitter:image", content: "https://tvg.gold/og-image.png" },
    ],
    links: [
    ...
    scripts: [
      {
        // Sitewide Organization entity — every page now carries the same, consistent
        // description/name/address rather than only the pages that happened to set their own.
        // See src/lib/seo.ts (organizationJsonLd) for the fields and what was deliberately
        // left out (no `sameAs` — could not verify real social profile URLs to cite).
